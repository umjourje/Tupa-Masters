...
Fluxo interativo (igual ao plot1):
  ...
  5. subplots com eixo x compartilhado: a janela "anda" pelo stride,
     com assíntotas verticais e as curvas trend/sazonal ARMAZENADAS.
...
def main():
    ...
    fig, axes = plt.subplots(len(starts), 1, figsize=(12, 2.4 * len(starts)),
    ...
    for k, ax in enumerate(axes):
        ...
        ax.plot(t, x[k], color="0.35", lw=1.0, label="original")
